...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.Navegador){
            ...
            enviarCorreo();
        }else if(id==R.id.reproductorAudio){
            abrirAudio();
        }else if(id==R.id.reproductorVideo){
            abrirVideo();
        }
    ...
    private void abrirVideo() {
        Intent intent = new Intent(MainActivity.this,VideoMediaActivity.class);
        startActivity(intent);
    }

    private void abrirAudio() {
        Intent intent = new Intent(MainActivity.this,AudioActivity.class);
        startActivity(intent);
    }

    private void enviarCorreo() {
        String correo="lamberto.fa@hotmail.com";
